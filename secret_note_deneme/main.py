...
def decrypted_notes():
    ...
    if len(message_encrypted) == 0 or len(master_secret) == 0:
        ...
        try:
            ...
            messagebox.showinfo(title="HATA!",message="Lütfen şifreyi giriinz")
...
title_info_label =Label(text="Başlığınızı giriniz ",font=FONT)
title_info_label.pack()

title_entry = Entry(width=30)
title_entry.pack()

input_info_label = Label(text="Sırrınız giriniz",font=FONT)
input_info_label.pack()

input_text = Text(width=30,height=20)
input_text.pack()

master_secret_label = Label(text="Şifrenizi giriniz",font=FONT)
...
decrypt_button = Button(text="Decrypt",command=decrypted_notes)
decrypt_button.pack()
